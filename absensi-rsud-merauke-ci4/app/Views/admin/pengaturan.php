...
<section class="kartu">
  ...
  <form method="post" action="<?= site_url('admin/pengaturan') ?>" id="form-atur">
    <?= csrf_field() ?>

    <div class="form-grup">
      <label>Nama Instansi</label>
      <input type="text" name="nama_instansi" value="<?= esc($nama) ?>">
    </div>
    ...
    <div class="form-baris">
      <div class="form-grup">
        ...
        <input type="text" name="lokasi_lat" id="lokasi_lat" required value="<?= esc($lat) ?>">
      </div>
      <div class="form-grup">
        <label class="wajib">Longitude</label>
        <input type="text" name="lokasi_lng" id="lokasi_lng" required value="<?= esc($lng) ?>">
      </div>
    </div>
    ...
    <div class="form-baris" style="margin-top:16px">
      <div class="form-grup">
        ...
        <input type="number" name="radius_meter" min="10" max="5000" required value="<?= esc($rad) ?>">
      ...
      <div class="form-grup">
        ...
        <input type="number" name="toleransi_menit" min="0" max="120" required value="<?= esc($tol) ?>">
...
<section class="kartu">
  ...
  <a class="btn btn-navy" href="<?= site_url('admin/pengaturan/backup') ?>">
...
<section class="kartu">
  ...
  <div class="aksi-baris" style="margin-top:12px">
    ...
    <span class="teks-kecil teks-redup">Contoh uji:
      <code>curl -H "X-API-KEY: …" <?= site_url('api/v1/ping') ?></code></span>
  </div>
</section>
...
(function () {
  ...
  var radius  = parseInt(<?= json_encode($rad) ?>, 10) || 100;
