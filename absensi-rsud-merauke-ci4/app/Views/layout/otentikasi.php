...
<title><?= esc($judul ?? 'Sistem Absensi Pegawai RSUD Merauke') ?></title>
...
<div class="auth-bungkus">
  <div class="auth-kartu <?= ! empty($lebar) ? 'lebar' : '' ?>">
    <div class="auth-kepala">
      <img class="logo" src="<?= base_url('assets/img/logo.svg') ?>" alt="Logo RSUD Merauke">
      <h1><?= $judulKartu ?? 'Sistem Absensi Pegawai<br>RSUD Merauke' ?></h1>
      <p><?= esc($subJudul ?? 'Kabupaten Merauke — Papua Selatan') ?></p>
