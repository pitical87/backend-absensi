...
Route::get('lupa-password', [LupaPasswordController::class, 'form'])->name('lupa-password');
Route::post('lupa-password', [LupaPasswordController::class, 'kirim'])->name('lupa-password.kirim');
Route::get('reset-password', [LupaPasswordController::class, 'formReset'])->name('reset-password');
Route::post('reset-password', [LupaPasswordController::class, 'prosesReset'])->name('reset-password.proses');
